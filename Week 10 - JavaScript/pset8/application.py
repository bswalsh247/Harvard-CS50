...
def articles():
    ...
    # get geo argument from HTML form and search for articles based on geo
    ...
    # using geo output JSON array of objects
...
def search():
    ...
    # get q from HTML form
    q = request.args.get("q") + "%"

    # get postal code, city, and state that start w/ q
...
# pw: AIzaSyDZQ9b2BWQJiCIP9h3OLT57J8FjaMf0DWM
