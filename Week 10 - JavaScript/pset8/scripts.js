...
$(function() {
    ...
    var options = {
        center: {lat: 39.838, lng: -104.9988}, // Stanford, California
...
{
    // TODO
    // Ah, a TODO. Ultimately, given a place (i.e., postal code and more),
    // this function will need to add a marker (i.e., icon) to the map.
    ...
    $.getJSON(Flask.url_for("articles"), {geo: place.postal_code}, function(articles) {
        ...
        if (!$.isEmptyObject(articles)) {
			...
			// build unordered list of links to articles
            var articlesContent = "<ul>";
            for (var i = 0; i < articles.length; i++) {

				// Adding each title w/ link to bullets in unordered list
            	articlesContent += "<li><a target='_blank' href='" + articles[i].link
            	+ "'>" + articles[i].title + "</a></li>";
            }
        }

        // end unordered list of articles
		articlesContent += "</ul>";
    ...
    // add marker to global markers array at the top
    markers.push(marker);
}
